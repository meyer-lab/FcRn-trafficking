...
sorts <- expand.grid(id = 1,
                     sortF = seq(0.4, 0.97, length.out = 40),
                     releaseF = seq(0, 1, length.out = 30))
...
ggplot(output, aes(x = sortF, y = releaseF, z = halfl)) + 
  geom_contour(aes(color = factor(..level..))) +
  scale_x_continuous(limits = c(0.4, 0.97)) +
